...
release = sira.__version__  # The full version, including alpha/beta/rc tags.
...
exclude_patterns = ["epilog.rst", ".DS_Store", "tex", ".bak"]
...
html_title = project + " v" + release + " docs"
...
latex_documents = [
    (master_doc, "SIRA.tex", "SIRA Documentation", "Maruf Rahman", "manual"),
]
...
man_pages = [(master_doc, "sira", "SIRA Documentation", [author], 1)]
