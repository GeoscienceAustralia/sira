...
project = sifra.__packagename__
copyright = sifra.__copyright__
author = sifra.__author__
...
release = sifra.__version__   # The full version, including alpha/beta/rc tags.
