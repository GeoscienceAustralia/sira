...
from scripts.convert_excel_files_to_json import update_json_structure, read_excel_to_json
...
def read_model_from_xlxs(config):
    ...
    json_obj = json.loads(read_excel_to_json(config.SYS_CONF_FILE), object_pairs_hook=OrderedDict)
