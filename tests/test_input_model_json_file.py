...
class TestReadingInfrastructureModelJsonFile(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.required_headers = ["component_list",
                                 "node_conn_df",
                                 "sysinp_setup",
                                 "sysout_setup"]
        self.required_component_headers = ["component_class",
                                           "component_type",
                                           "cost_fraction",
                                           "node_cluster",
                                           "node_type",
    ...
    def test_json_structure(self):
        ...
        for model_file in self.model_json_files:
            try:
                ...
                self.assertTrue(model_json_object is not None,
                                "None value object.")
            except ValueError:
    ...
    def test_required_headers_exist(self):
        for model_file in self.model_json_files:
            ...
            self.assertTrue(
                ...
                "Required header name not found in " +model_file + " !")
        ...
        for model_file in self.model_json_files:
            ...
            for component in component_list.keys():
                self.assertTrue(
                    ...
                    "Required header name in components not found in " +
                    model_file+str(set(component_list[component].keys())) +
                    " !")
